...
<body class="is-preload" style="font-family: 'omyu_pretty'">
	...
	<!-- Main -->
		...
		<script type="text/javascript"
			src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f10820eabaa54ae04edeaff87ad91b9c&libraries=services"></script>
		<script>
	    ...
	    mapOption = { 
	        center: new kakao.maps.LatLng(35.152405, 126.888352), // 지도의 중심좌표
	        level: 4 // 지도의 확대 레벨 
	    };
		...
		if (navigator.geolocation) {
		    ...
		    var locPosition = new kakao.maps.LatLng(35.152405, 126.888352),    
	    ...
	    console.log(lon);
		    ...
		    ps.keywordSearch(keyword, placesSearchCB, {location: latlng, radius: 3000, sort: kakao.maps.services.SortBy.DISTANCE, size: 7}); 
		}
