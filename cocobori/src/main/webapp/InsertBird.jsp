...
<body class="is-preload" style="font-family: 'omyu_pretty'">
	...
	<div id="main">
		...
		<img class="icon_pet" alt="" src="./images/icon_bird.gif"><span class="sub_title">조류 백과사전 등록</span>
			...
			<div class="container-b" style="width: 70%;">
				<form action="InsertBird" method="post" enctype="multipart/form-data">
					...
					<div class="form-floating" style="margin-bottom: 5px;">
						<input type="text" name="pet_cage" class="form-control-sm" placeholder="새장">
					</div>
					<div class="form-floating" style="margin-bottom: 5px;">
						<input type="text" name="pet_health" class="form-control-sm" placeholder="질병">
					</div>
					<div class="form-floating" style="margin-bottom: 5px;">
						<input type="text" name="pet_adapt" class="form-control-sm" placeholder="성격">
					</div>
					<div class="form-floating" style="margin-bottom: 5px;">
						<input type="text" name="pet_etc" class="form-control-sm" placeholder="유의사항">
					</div>
