...
<body class="is-preload" style="font-family: 'omyu_pretty'">
	...
	<div id="main">
		<section class="two" style="padding-top: 20px; padding-bottom: 20px;">
			<span class="sub_title">반려동물 백과사전 등록</span>
			<h4>반려동물들에 대한 모든것!</h4>
			<br>
			...
			<div class="container-a" style="width: 70%; font-size: 18px;">
				<div>
					...
					<button type="button" class="btn btn-light btn-lg"
						style="background-color: #55cbcd;"
						onclick="location.href='InsertDog.jsp'">강아지 백과사전 정보 등록</button>
				</div>
				<div>
					<img class="icon_pet" alt="" src="./images/icon_cat.gif">
					<button type="button" class="btn btn-light btn-lg"
						style="background-color: #caa6fe;"
						onclick="location.href='InsertCat.jsp'">고양이 백과사전 정보 등록</button>
				</div>
				<div>
					<img class="icon_pet" alt="" src="./images/icon_rep.gif">
					<button type="button" class="btn btn-light btn-lg"
						style="background-color: #a9d39e;"
						onclick="location.href='InsertRep.jsp'">파충류 백과사전 정보 등록</button>
				</div>
				<div>
					<img class="icon_pet" alt="" src="./images/icon_bird.gif">
					<button type="button" class="btn btn-light btn-lg"
						style="background-color: #b37c57;" onclick="location.href='InsertBird.jsp'">조
						류 백과사전 정보 등록</button>
				</div>
				<button type="button" class="btn btn-light btn-lg"
					style="background-color: #4C3D3D;"
